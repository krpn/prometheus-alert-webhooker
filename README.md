...
| job parameter <parameter_name> | optional | Pass <parameter_name> to job                                                                                                                                                                                                  |
| state_refresh_delay            | optional | How often executor will be refresh job status when executing. Default if not set: 15s. Example: 5s                                                                                                                            |
| secure_interations_limit       | optional | How many refresh status iterations will be until Job will be considered hung and executor release it. Default if not set: 1000. Example: 500                                                                                  |